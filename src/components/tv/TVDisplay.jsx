...
const TVDisplay = () => {
    const phrases = useMemo(() => [
        ...
        "Un bon developpeur apprend chaque jour.",
        "La perseverance fait la difference.",
        "Le travail en equipe ameliore les projets.",
        ...
        "Un projet bien structure est plus facile a maintenir.",
        "La pratique reguliere ameliore les competences.",
        "Un bon design rend une application agreable.",
        "La simplicite est souvent la meilleure solution.",
        "Tester son code evite beaucoup de problemes.",
        "La curiosite pousse a progresser.",
        "Chaque bug est une opportunite d apprendre.",
        "Le developpement demande du temps et de la patience.",
